...
public class ParseHTML {
    ...
    /**
     * Read a single byte of data from the HTML source, if this
     * function returns 1000 then you should call getTag to
     * see what tag was found. Otherwise the value returned is
     * simply the next character found. (-1000 if the end reached).
     *
